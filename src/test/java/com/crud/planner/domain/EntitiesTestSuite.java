...
public class EntitiesTestSuite {
    ...
    public void testMeetingEntityWithLocationUsersAndGroups() {
        ...
        User meetingOwner = new User(null, "Maciej", "Witecki", "mackowit@o2.pl", financialGroup );
        ...
        userRepository.save(meetingOwner);
        Long ownerId = meetingOwner.getId();
